...
const ArmacaoPolicorte = ({ handleBackToCarpintaria, handleNextPage, dadosIniciais = {} }) => {
  ...
  const handleAvancar = () => {
    if (isFormCompleto()) {
      ...
      const dados = {
        respostasArmacaoPolicorte: respostas
      };
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
                  Avalie as condições da área de armação e do uso de policorte no canteiro de obras.
                  Essa avaliação é fundamental para garantir a segurança dos trabalhadores durante
                  o manuseio de ferramentas de corte e a preparação de armações.
                </Typography>
                ...
                <Stepper activeStep={14} orientation="vertical" sx={{ mb: 3 }}>
                  {STEPS.map((label) => (
                    <Step key={label}>
          ...
          <Card elevation={4} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="subtitle1">
                Avaliação das condições de segurança na área de armação e uso de policorte
              </Typography>
            </Box>
            ...
            <Box sx={{ p: 4 }}>
              <Grid container spacing={1} sx={{ mb: 4 }}>
                <Grid item xs={12}>
                  ...
                  >
                    <BuildIcon sx={{ mr: 1 }} /> Área de Armação
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, mb: 3 }}>
                    Avalie se a área de armação e equipamentos de policorte atendem aos requisitos de segurança.
                  </Typography>
                </Grid>
              </Grid>

              {/* Perguntas sobre armação e policorte */}
              <Questao 
                numero="83"
                texto="A armação possui piso resistente, nivelado e antiderrapante?"
                name="pisoResistente"
              ...
              <Questao 
                numero="85"
                texto="O operador está treinado para operação de policorte?"
              ...
              <Questao 
                numero="88"
                texto="Na armação possui sinalização e proibição?"
              ...
              <Questao 
                numero="90"
                texto="O equipamento possui coifa de proteção, dispositivo de partida e parada com botão de emergência, aterramento, extintor de incêndio e checklist diário?"
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      <Button 
                        variant="outlined" 
                        onClick={handleBackToCarpintaria}
...
export default ArmacaoPolicorte;