...
const AndaimeSuspensoMotorizado = ({ handleBackToAndaimeSuspenso, handleNextPage, dadosIniciais = {} }) => {
  ...
  const [respostas, setRespostas] = useState(dadosIniciais || {
    cabosAlimentacaoDuploIsolamento: '',
    pluguesTomadasBlindadas: '',
    limitadorFimCurso: '',
    dispositivosImpedirMovimentacao: '',
    dispositivoMecanicoEmergencia: ''
  });
  ...
  const handleAvancar = () => {
    if (isFormCompleto()) {
      ...
      const dados = {
        respostasAndaimeSuspensoMotorizado: respostas
      };
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
                  Avalie as condições do andaime suspenso motorizado no canteiro de obras.
                ...
                <Stepper activeStep={20} orientation="vertical" sx={{ mb: 3 }}>
                  {STEPS.map((label) => (
                    <Step key={label}>
          ...
          <Card elevation={4} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="subtitle1">
                Avaliação das condições de segurança dos andaimes suspensos motorizados no canteiro de obras
              </Typography>
            </Box>
            ...
            <Box sx={{ p: 4 }}>
              <Grid container spacing={1} sx={{ mb: 4 }}>
                <Grid item xs={12}>
                  ...
                  >
                    <ElectricalServicesIcon sx={{ mr: 1 }} /> Andaime Suspenso Motorizado
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, mb: 3 }}>
                    Avalie se os andaimes suspensos motorizados atendem aos requisitos de segurança estabelecidos nas normas.
                  </Typography>
                </Grid>
              </Grid>

              {/* Perguntas sobre andaime suspenso motorizado */}
              <Questao 
                numero="156"
                texto="O andaime suspenso motorizado possui cabos de alimentação com duplo isolamento."
                name="cabosAlimentacaoDuploIsolamento"
                value={respostas.cabosAlimentacaoDuploIsolamento}
              />
              
              <Questao 
                numero="157"
                texto="Plugues e tomadas blindadas."
                name="pluguesTomadasBlindadas"
                value={respostas.pluguesTomadasBlindadas}
              />
              
              <Questao 
                numero="158"
                texto="Limitador de fim de curso superior e batente."
                name="limitadorFimCurso"
                value={respostas.limitadorFimCurso}
              />
              
              <Questao 
                numero="159"
                texto="Dispositivos que impeçam sua movimentação, quando sua inclinação for superior a 15° (quinze graus)?"
                name="dispositivosImpedirMovimentacao"
                value={respostas.dispositivosImpedirMovimentacao}
              />
              
              <Questao 
                numero="160"
                texto="Dispositivo mecânico de emergência."
                name="dispositivoMecanicoEmergencia"
                value={respostas.dispositivoMecanicoEmergencia}
              />
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      <Button 
                        variant="outlined" 
                        onClick={handleBackToAndaimeSuspenso}
...
export default AndaimeSuspensoMotorizado;