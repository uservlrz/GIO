...
import MixerIcon from '@mui/icons-material/Blender';
...
const Betoneira = ({ handleBackToArmacaoPolicorte, handleNextPage, dadosIniciais = {} }) => {
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
                  Avalie as condições da betoneira no canteiro de obras.
                  É fundamental garantir que o equipamento e área de operação
                ...
                <Stepper activeStep={15} orientation="vertical" sx={{ mb: 3 }}>
                  {STEPS.map((label) => (
                    <Step key={label}>
          ...
          <Card elevation={4} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="subtitle1">
                Avaliação das condições de segurança da betoneira no canteiro de obras
              </Typography>
            </Box>
            ...
            <Box sx={{ p: 4 }}>
              <Grid container spacing={1} sx={{ mb: 4 }}>
                <Grid item xs={12}>
                  ...
                  >
                    <MixerIcon sx={{ mr: 1 }} /> Betoneira
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, mb: 3 }}>
                    Avalie se a betoneira e área de operação atendem aos requisitos de segurança estabelecidos nas normas.
                  </Typography>
                </Grid>
              </Grid>

              {/* Perguntas sobre betoneira */}
              <Questao 
                numero="91"
                texto="A betoneira possui piso resistente, nivelado e antiderrapante?"
                name="pisoResistente"
              ...
              <Questao 
                numero="93"
                texto="O operador está treinado para operação de betoneira?"
              ...
              <Questao 
                numero="96"
                texto="Na área da betoneira possui sinalização e proibição?"
              ...
              <Questao 
                numero="98"
                texto="O equipamento possui proteção de partes vivas, coifa de proteção, aterramento, extintor de incêndio, checklist diário e dispositivo de partida e parada com botão de emergência com chave?"
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      <Button 
                        variant="outlined" 
                        onClick={handleBackToArmacaoPolicorte}
