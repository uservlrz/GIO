            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
                  Verifique a conformidade dos projetos técnicos necessários para a
                  segurança da obra. Estes documentos são essenciais para garantir
                  a integridade das instalações e a proteção dos trabalhadores.
                </Typography>
          ...
          <Card elevation={4} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="subtitle1">
                Verificação dos projetos técnicos e sistemas de proteção
              </Typography>
            </Box>
            ...
            <Box sx={{ p: 4 }}>
              <Grid container spacing={1} sx={{ mb: 4 }}>
                <Grid item xs={12}>
                  ...
                  >
                    <ConstructionIcon sx={{ mr: 1 }} /> Projetos Técnicos
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, mb: 3 }}>
                    Avalie a existência e conformidade dos projetos técnicos necessários para a obra.
                  </Typography>
                </Grid>
              </Grid>
              ...
              <Questao 
                numero="13"
                texto="A obra possui os projetos de canteiro de obras / áreas de vivência?"
                name="projetosCanteiro"
                value={respostas.projetosCanteiro}
              />
              
              <Questao 
                numero="14"
                texto="A obra possui o projeto elétrico das instalações temporárias e laudo de aterramento?"
              ...
              <Questao 
                numero="15"
                texto="A obra possui os projeto dos sistemas de proteção coletiva?"
                name="projetoProtecaoColetiva"
                value={respostas.projetoProtecaoColetiva}
              />
              
              <Questao 
                numero="16"
                texto="A obra possui os projeto dos sistemas de proteção individual contras quedas (SPIQ)?"
                name="projetoSPIQ"
                value={respostas.projetoSPIQ}
              />
              
              <Questao 
                numero="17"
                texto="A obra possui projeto de SPDA - Sistema de proteção contra descargas atmosféricas?"
                name="projetoSPDA"
                value={respostas.projetoSPDA}
              />
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      <Button 
                        variant="outlined" 
                        onClick={handleBackToDocumentacao}
