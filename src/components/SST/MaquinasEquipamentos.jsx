...
const MaquinasEquipamentos = ({ handleBackToEscadasRampas, handleNextPage, dadosIniciais = {} }) => {
  ...
  const handleAvancar = () => {
    if (isFormCompleto()) {
      ...
      const dados = {
        respostasMaquinasEquipamentos: respostas
      };
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
                  Avalie as condições de máquinas e equipamentos do canteiro de obras.
                  O uso adequado de máquinas e equipamentos é essencial para
                ...
                <Stepper activeStep={12} orientation="vertical" sx={{ mb: 3 }}>
                  {STEPS.map((label) => (
                    <Step key={label}>
          ...
          <Card elevation={4} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="subtitle1">
                Avaliação da segurança de máquinas e equipamentos no canteiro de obras
              </Typography>
            </Box>
            ...
            <Box sx={{ p: 4 }}>
              <Grid container spacing={1} sx={{ mb: 4 }}>
                <Grid item xs={12}>
                  ...
                  >
                    <ConstructionIcon sx={{ mr: 1 }} /> Segurança em Máquinas
                  </Typography>
                  <Typography variant="body2" color="text.secondary" sx={{ mt: 1, mb: 3 }}>
                    Avalie se as máquinas e equipamentos atendem às normas de segurança.
                  </Typography>
                </Grid>
              </Grid>

              {/* Perguntas sobre máquinas e equipamentos */}
              <Questao 
                numero="73"
                texto="As máquinas e equipamentos estão atendendo ao disposto na NR 12?"
                name="atendendoNR12"
                value={respostas.atendendoNR12}
              />
              
              <Questao 
                numero="74"
                texto="O canteiro de obras possui procedimento de segurança para trabalho com máquinas e equipamentos e ferramentas?"
                name="procedimentoSeguranca"
                value={respostas.procedimentoSeguranca}
              />
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                      <Button 
                        variant="outlined" 
                        onClick={handleBackToEscadasRampas}
...
export default MaquinasEquipamentos;